...
namespace CaoQuocViet.XuLyLuuTru
{
    ...
    {
        public const string loaihangFile = "Data/LoaiHang.json";
        ...
        public static void LuuDanhSach(LoaiHang[] DSloaihang)
        {
        ...
        public static string Sua(LoaiHang loaihangOld, LoaiHang loaihangNew)
        {
            LoaiHang[] DSloaihang = DocDanhSach("");
        ...
        public static string Xoa(LoaiHang loaihang)
        {
            LoaiHang[] DSloaihang = DocDanhSach("");
