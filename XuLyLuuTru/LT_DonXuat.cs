...
{
    public class LT_DonXuat
    {
        public const string donxuatFile = "Data/DonXuat.json";
        ...
        public static void LuuDanhSach(DonXuat[] DSdonxuat)
        {
        ...
        public static string Them(DonXuat donxuat)
        {
            DonXuat[] DSdonxuat = DocDanhSach("");
        ...
        public static string Sua(DonXuat donxuatOld, DonXuat donxuatNew)
        {
            DonXuat[] DSdonxuat = DocDanhSach("");
        ...
        public static DonXuat? ReadInfo(string donxuatCode)
        {
            DonXuat[] DSdonxuat = DocDanhSach("");
